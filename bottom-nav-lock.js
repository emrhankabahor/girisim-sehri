...
(function(){
  ...
  function ensureStyle(){
    ...
    s.textContent=`
      ...
      #profile{scroll-margin-top:220px!important}
  ...
  /* Menü tıklamalarını ve hash yönlendirmesini değiştirmiyoruz. Profil hedefinin
     scroll-margin değeri tarayıcının #profile anchor'ına geçerken sayfayı aşağı
